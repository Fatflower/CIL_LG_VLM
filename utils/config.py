...
class Config:
    ...
    def __init__(self, config_mode=None):
        ...
        parser.add_argument('--test_dir', type=str, default=None, help="trained model directory")
        ...
        parser.add_argument('--use_valid', action="store_true", default=None, help='use valid dataset or not (default False)')
        parser.add_argument('--split_dataset', action="store_true", default=None, help='split dataset into several step or not')
        parser.add_argument('--img_size', type=int, default=None, help='if not config will follow origin size of dataset')
        parser.add_argument('--shuffle', action="store_true", default=None, help='shuffle class order')
        parser.add_argument('--split_for_valid', action="store_true", default=None, help='whether to split training set to true training set and valid set') # 赋初值为 None 相当于 False
        
        parser.add_argument('--backbone', type=str, default=None, help='backbone to train')
        parser.add_argument('--MLP_projector', action="store_true", default=None, help='use MLP projector behind backbone or not')
        ...
        parser.add_argument('--apply_nme', action="store_true", default=None, help='whether apply nme to classify')

        parser.add_argument('--incre_type', type=str, default=None, help='Incremental type e.t. cil or til')
        parser.add_argument('--pretrained', action="store_true", default=None, help='whether use pretrained network weights to initial the network')
        parser.add_argument('--pretrain_path', type=str, default=None, help='prtrained network weights path to load')
        parser.add_argument('--freeze_fe', action="store_true", default=None, help='freeze the feature extractor')
        parser.add_argument('--save_models', action="store_true", default=None, help='save trained models weights')
        parser.add_argument('--save_pred_record', action="store_true", default=None, help='save model predict record')
        ...
        parser.add_argument('--openset_test', action="store_false", default=None, help='apply openset test or not.')
        ...
        parser.add_argument('--init_nesterov', action="store_true", default=None, help='init nesterov for sgd')
        ...
        parser.add_argument('--nesterov', action="store_true", default=None, help='nesterov for sgd')
        ...
        parser.add_argument('--fixed_memory', action="store_true", default=None, help='fix memory size for each class')
        parser.add_argument('--memory_per_class', type=int, default=None, help='memory size per class for fixed memory')
