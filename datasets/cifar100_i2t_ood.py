...
class CIFAR100_I2T_OOD(iData):
    ...
    def download_data(self):
        ...
        base_dir = os.path.join(data_path,"cifar100_ood_images")  # cifar100_ood_images
        train_dir = os.path.join(base_dir, "train_OOD_28")
        test_dir = os.path.join(base_dir, "train_OOD_28")
