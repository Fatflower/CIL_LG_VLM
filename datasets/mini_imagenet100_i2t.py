...
class Mini_Imagenet100_I2T(iData):
    '''
    ...
    def getdata(self, file_dir):
        ...
        sorted_items = sorted(class_names, key=lambda s: s.lower())
        class_names = sorted_items
        data = []
        targets = []
        # id_des = []
        # ood_des = []
    ...
    def download_data(self):
        data_path = "/home/2021/wentao/Datasets" # 30server
        # data_path = "/data31/data31_1/Public/Datasets"
        # data_path = "/home/zhangwentao/Dataset2"
        # data_path = "/home/2021/wentao/Storage/tmp/CLIP_OOD_detection_CIL/data"
        base_dir = os.path.join(data_path,"miniImageNet")
