...
class Skin40_I2T_OOD(iData):
    ...
    def download_data(self):
        ...
        test_dir = os.path.join(os.environ["DATA"], "SD-198/main_classes_split/train_1.txt")
        img_dir = os.path.join(os.environ["DATA"], 'skin40_OOD_28')
